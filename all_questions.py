...
def question6():
    ...
    # type: explain_string
    answers['(b) C2 better classifier than C1? Explain'] = "Yes, C2 is not better than C1 because increasing the probability of predicting the + class equally increases both TPR and FPR, thus maintaining performance equivalent to random chance."
    # type: string
    # choices: ['TPR/FPR', 'precision/recall']
    answers['(c) Which metric?'] = 'precision/recall'

    # type: explain_string
    answers['(c) explain'] = "It emphasizes the trade-off between correctly predicting positive cases and minimizing incorrect positive predictions, which is crucial for balanced performance assessment."
    return answers
